...
class ParameterOperation:
    ...
    def get_cfg_path(filename: str = None):
        if filename:
            return str(Path(__file__).parent.resolve() / "config" / filename)
        else:
            return str(Path(__file__).parent.resolve() / "config")
    ...
    @staticmethod
    def txt2img_params_normalization(user_params: dict):
    ...
    @staticmethod
    def img2img_params_normalization(user_params: dict, user_images: list = None):
    ...
    @staticmethod
    def extra_params_normalization(user_params: dict, user_images: list = None):
    ...
    @staticmethod
    def tagger_params_normalization(user_params: dict, user_images: list = None):
